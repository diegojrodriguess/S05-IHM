...
function reservarArmario() {
  ...
  let time = Date.now()
  let time_reserve = new Date(time)

  let devolution_time = new Date(time)
  devolution_time.setDate(time_reserve.getDate() + 1)
  ...
  armarioEmprestado.reserve = time_reserve.toDateString()
  armarioEmprestado.devolution = devolution_time.toDateString()
  ...
  O horário de devolução é: ${devolution_time.toLocaleString()}`;
