...
// Função para adicionar eventos ao carrossel
function addEventsToCarousel(events) {
...
addEventsToCarousel(eventos);

// Lógica para navegação do carrossel
let currentIndex = 0;
...
function updateCarousel() {
    ...
    carouselContainer.style.transform = `translateX(-${currentIndex * (cardWidth + 16)}px)`;
}